    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            setInterval(function(){
                ...
                fechaR = momentoActual.getDate()+"-"+(momentoActual.getHours()-12)+":"+momentoActual.getMinutes();
        ...
        function sumatoria(temperaturas,tiempo){
            if(temperaturas.length == tiempo.length){
               var respuesta = 0;
                for(var i = 0; i < temperaturas.length;i++){
                    respuesta += temperaturas[i]*tiempo[i];
                }
                return respuesta;
            }
            else{
        ...
        function sumatoriaU(dato,potencia){
            if(dato.length >= 0){
               var respuesta = 0;
                for(var i = 0; i < dato.length;i++){
                    if(potencia){
                        respuesta += Math.pow(dato[i],2);   
                    }
                    else{
                        respuesta += dato[i];
                    }
